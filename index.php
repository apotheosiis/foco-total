...
<body>
    ...
    <header class="header">
        <nav class="navbar">
            ...
            <div class="nav-cta">
                <a href="public/login.php" class="btn btn-primary">Abrir App</a>
            </div>
    ...
    <main>
        ...
        <section class="hero">
            <div class="container">
                ...
                <a href="public/register.php" class="btn btn-primary">Comece a usar de graça</a>
        ...
        <section id="testimonials" class="testimonials fade-in-section">
            <div class="container testimonials-grid">
                <div class="testimonials-content">
                    ...
                    <a href="public/register.php" class="btn btn-primary">Experimente agora</a>
                </div>
